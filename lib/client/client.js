...
exports.toDate = exports.blobToString = exports.toUUID = exports.toResultSet = void 0;
const query_pb_1 = require("../proto/query_pb");
const toResultSet = (response) => {
    const resultSet = response.getResultSet();
    const data = resultSet === null || resultSet === void 0 ? void 0 : resultSet.getData();
    // TODO: will this ever throw? How do we know it's legit?
    const test = query_pb_1.ResultSet.deserializeBinary(data === null || data === void 0 ? void 0 : data.getValue());
    return test;
};
