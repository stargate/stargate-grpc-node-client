...
class TableBasedCallCredentials extends grpc_js_1.CallCredentials {
    ...
    compose(callCredentials) {
        ...
        const newCreds = new TableBasedCallCredentials(__classPrivateFieldGet(this, _TableBasedCallCredentials_username, "f"), __classPrivateFieldGet(this, _TableBasedCallCredentials_password, "f"));
