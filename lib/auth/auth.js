...
class TableBasedCallCredentials extends grpc_js_1.CallCredentials {
    ...
    compose(callCredentials) {
        ...
        const newCredsConfig = { username: __classPrivateFieldGet(this, _TableBasedCallCredentials_username, "f"), password: __classPrivateFieldGet(this, _TableBasedCallCredentials_password, "f") };
