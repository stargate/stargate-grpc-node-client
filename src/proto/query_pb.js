...
goog.exportSymbol('proto.stargate.TypeSpec.MapFixMe', null, global);
 ...
 * @constructor
 */
proto.stargate.TypeSpec.MapFixMe = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.stargate.TypeSpec.MapFixMe, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.stargate.TypeSpec.MapFixMe.displayName = 'proto.stargate.TypeSpec.MapFixMe';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.stargate.Value.prototype.getUuid = function() {
  return /** @type{?proto.stargate.Uuid} */ (
    jspb.Message.getWrapperField(this, proto.stargate.Uuid, 9));
};
...
proto.stargate.Value.prototype.getCollection = function() {
  return /** @type{?proto.stargate.Collection} */ (
    jspb.Message.getWrapperField(this, proto.stargate.Collection, 12));
};
...
proto.stargate.Value.prototype.getUdt = function() {
  return /** @type{?proto.stargate.UdtValue} */ (
    jspb.Message.getWrapperField(this, proto.stargate.UdtValue, 13));
};
...
proto.stargate.Value.prototype.getVarint = function() {
  return /** @type{?proto.stargate.Varint} */ (
    jspb.Message.getWrapperField(this, proto.stargate.Varint, 14));
};
...
proto.stargate.Value.prototype.getDecimal = function() {
  return /** @type{?proto.stargate.Decimal} */ (
    jspb.Message.getWrapperField(this, proto.stargate.Decimal, 15));
};
...
proto.stargate.Query.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.stargate.Payload.serializeBinaryToWriter
    );
  }
...
proto.stargate.Query.prototype.getValues = function() {
  return /** @type{?proto.stargate.Payload} */ (
    jspb.Message.getWrapperField(this, proto.stargate.Payload, 2));
};
...
proto.stargate.TypeSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    map: (f = msg.getMap()) && proto.stargate.TypeSpec.MapFixMe.toObject(includeInstance, f),
...
proto.stargate.TypeSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.stargate.TypeSpec.MapFixMe;
      reader.readMessage(value,proto.stargate.TypeSpec.MapFixMe.deserializeBinaryFromReader);
      msg.setMap(value);
      break;
    case 3:
...
proto.stargate.TypeSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.stargate.TypeSpec.MapFixMe.serializeBinaryToWriter
    );
  }
  f = message.getList();
  if (f != null) {
 ...
 * @return {!Object}
 */
proto.stargate.TypeSpec.MapFixMe.prototype.toObject = function(opt_includeInstance) {
  return proto.stargate.TypeSpec.MapFixMe.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.stargate.TypeSpec.MapFixMe} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.stargate.TypeSpec.MapFixMe.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.stargate.TypeSpec.MapFixMe}
 */
proto.stargate.TypeSpec.MapFixMe.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.stargate.TypeSpec.MapFixMe;
  return proto.stargate.TypeSpec.MapFixMe.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.stargate.TypeSpec.MapFixMe} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.stargate.TypeSpec.MapFixMe}
 */
proto.stargate.TypeSpec.MapFixMe.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.stargate.TypeSpec.MapFixMe.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.stargate.TypeSpec.MapFixMe.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.stargate.TypeSpec.MapFixMe} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.stargate.TypeSpec.MapFixMe.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.stargate.TypeSpec}
 */
proto.stargate.TypeSpec.MapFixMe.prototype.getKey = function() {
 ...
 * @return {!proto.stargate.TypeSpec.MapFixMe} returns this
*/
proto.stargate.TypeSpec.MapFixMe.prototype.setKey = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.stargate.TypeSpec.MapFixMe} returns this
 */
proto.stargate.TypeSpec.MapFixMe.prototype.clearKey = function() {
 ...
 * @return {boolean}
 */
proto.stargate.TypeSpec.MapFixMe.prototype.hasKey = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.stargate.TypeSpec}
 */
proto.stargate.TypeSpec.MapFixMe.prototype.getValue = function() {
  return /** @type{?proto.stargate.TypeSpec} */ (
 ...
 * @return {!proto.stargate.TypeSpec.MapFixMe} returns this
*/
proto.stargate.TypeSpec.MapFixMe.prototype.setValue = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.stargate.TypeSpec.MapFixMe} returns this
 */
proto.stargate.TypeSpec.MapFixMe.prototype.clearValue = function() {
 ...
 * @return {boolean}
 */
proto.stargate.TypeSpec.MapFixMe.prototype.hasValue = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
/**
 * optional MapFixMe map = 2;
 * @return {?proto.stargate.TypeSpec.MapFixMe}
 */
proto.stargate.TypeSpec.prototype.getMap = function() {
  return /** @type{?proto.stargate.TypeSpec.MapFixMe} */ (
    jspb.Message.getWrapperField(this, proto.stargate.TypeSpec.MapFixMe, 2));
};


/**
 * @param {?proto.stargate.TypeSpec.MapFixMe|undefined} value
 * @return {!proto.stargate.TypeSpec} returns this
*/
...
proto.stargate.Response.prototype.getResultSet = function() {
  return /** @type{?proto.stargate.Payload} */ (
    jspb.Message.getWrapperField(this, proto.stargate.Payload, 1));
};
